...
function middleArm() {
    ...
    //var instanceMatrix = mult(s, translate(  0.0, 0.5 * MIDDLE_ARM_HEIGHT, 0.0 ));

    //console.log("instanceMatrix", instanceMatrix);

    var t = mult(modelViewMatrix, instanceMatrix);

    //console.log("middle arm mv", modelViewMatrix);

    gl.uniformMatrix4fv( modelViewMatrixLoc,  false, flatten(t)  );
    gl.drawArrays( gl.TRIANGLES, 0, NumVertices );

    //console.log("middle arm t", t);
...
function render() {
    ...
    modelViewMatrix = mult(modelViewMatrix, translate(-BASE_WIDTH/2, BASE_HEIGHT, 0.0));
